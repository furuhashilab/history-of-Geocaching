...
この頃、ニューヨーク州のQuinn という名前のジオキャッシャーが、Navicacheという名前の地域ジオキャッシングのウェブサイトを立ち上げました。報道によると、 Jeremy Irishは、Quinnのサイトが"geocaching"という言葉の使用を削除しない限り、訴訟を起こすと激怒したという。Quinn は抵抗し、代わりにNavicache.comを本格的なジオキャッシングのリソースに変え、キャッシュリストを追加した。Navicache.comはキャッシュリストの最大の代替データベースとなりました。

カリフォルニアの Ed Hall （別名Buxley）というジオキャッシャーは、ジオキャッシュの場所を示すオンラインマップを作成しました。2001年5月、 Jeremy Irishは、ジオキャッシングという新しいスポーツを促進するためのバクスリーの貢献を歓迎するどころか、バクスリーが彼の地図に "Geocaching Data Copyright 2001 Grounded, Inc. "と記載された著作権表示を追加しない限り、法的措置を取ると脅しました。Jeremy Irish氏はまた、ジオキャッシング・ドットコムからBuxley氏のウェブページへのリンクを削除し、自身の基本的なマッピング機能のリリースを発表した。この事件は、Slashdotの記事で報じられると、広く注目を集めた。

2001年5月、Jeremy Irish氏はゲームを「無料」で「非商業的」なものにすることを公約したにもかかわらず、geocaching.comのビジネスモデルをより直接的に有料の世界へと拡大した。バナー広告、服の販売、ジオキャッシングの日誌、車用のステッカー、シールなどの販売に加えて、彼は「メンバー専用のキャッシュ」と有料のヒッチハイカーのログを導入しました。メンバー限定のキャッシュは年会費３０ドルを支払った人だけがアクセスできるようなものでした。同様に、サイト独自のログインシステムを使ってヒッチハイカーの動きを追跡する機能、『別名トラベルバグス（TM）』は、ヒッチハイカー1人につき5.95ドルを支払った人だけが利用できるようになりました（もちろん、非公式で自家製のヒッチハイカーを追跡する方法は無料のままでした）。これらの動きは一部のジオキャッチャーを動揺させたが、他のジオキャッチャーはJeremy Irishを擁護し、新しい課金システムは確固たるものとなった。2003年半ばまでに、geocaching.comは15万人以上の登録ユーザーを持ち、その中には年間30ドルの有料購読者が7,200人いたと推定されます。

先に設立されたNavicache.comの他にも、geocaching.comが商業化を進め、ゲームを独占的にコントロールするようになった反動で、新たなジオキャッシングサイトが登場しました。それがGeocachingWorldwideです。これはオーストラリアのジオキャッシャーであるJeremy Hurstによって開発されたもので、彼は、複数のウェブサイトがジオキャッシュの座標に関するデータを共有するシステムの開発に興味を持っていました。サイトは、ジオキャッシャー自身が投稿したジオキャッシュのデータではなく、機能で自由に競うことになるだろう。有望な始まりであったにもかかわらず、ウェブマスターの仕事や家庭へ割く時間の要求が開発の継続を妨げ、GeocachingWorldwideの活動は２００１年の終わりに停止しました。
